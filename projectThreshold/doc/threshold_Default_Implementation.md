...
The pixel list of this image has been concatenated to obtain a larger* image from the original one.  Thus, from a 360x288 image, we obtain 360x576, 360x864, 360x1152 and 360x1440 images.
...
<figure>
    ...
    <center><figcaption>Figure 3: Results of the Benchmark with time in milliseconds.</figcaption></center>
</figure>
